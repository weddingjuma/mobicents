...
public class EventRouterExecutorImpl implements EventRouterExecutor {
	...
	public void routeEvent(EventContext event) {
		...
		System.out.println("当前执行的executor的是："+executor.hashCode());
		System.out.println("当前执行的executor的阻塞队列中的数量:"+((ThreadPoolExecutor)executor).getQueue().size());
	}
	...
	/*
	 * @sainty 重写了toString方法，用于获取当前每个executor的LinkedBlockingQueue中排队的数量
	*/
